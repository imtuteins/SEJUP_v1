...
public class CasoService {
    ...
    public String crearCaso(CrearCasoRequest crearCasoRequest){
        ...
        Usuario clieteExistente = usuarioRepository.findById(crearCasoRequest.cliente()).orElseThrow(()
    ...
    public String asignarCaso(AsignarCasoRequest asignarCasoRequest){
        ...
        Caso casoExistente = casoRepository.findById(asignarCasoRequest.idCaso()).orElseThrow(()
                -> new RuntimeException("caso no encontrado"));
